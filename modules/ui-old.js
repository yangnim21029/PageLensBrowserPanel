 ...
 * 處理所有 UI 相關的更新和渲染
 */
import { getAssessmentTranslation, impactTranslations, typeTranslations } from './assessment-translations.js';
...
export class UI {
  constructor() {
    ...
    this.currentLanguage = 'zh-TW'; // 預設使用中文
  }
  ...
  /**
   * 獲取翻譯後的評估內容
   * @param {Object} issue - API 返回的評估項目
   * @returns {Object} 包含翻譯後的名稱、標題、描述和建議
   */
  getTranslatedAssessment(issue) {
    // 獲取評估 ID（API 可能返回 assessmentId 或 id）
